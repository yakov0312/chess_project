...
namespace chessGraphics
{
    public partial class Form1 : Form
    {
        ...
        private void paintBoard(string board)
        {
            ...
            btnBoard.FlatAppearance.MouseOverBackColor = Color.Gold;
            ...
            for (i = 0; i < BOARD_SIZE; i++)
            {
                ...
                for (j = 0; j < BOARD_SIZE; j++)
                {
                    ...
                    newBtn.BackColor = isColBlack ? Color.BurlyWood : Color.SaddleBrown;
        ...
        void lastlbl_Click(object sender, EventArgs e)
        {
            ...
            if (srcSquare != null)
            {
                ...
                if (matBoard[srcSquare.Row, srcSquare.Col] == b)
                {
                    ...
                    matBoard[srcSquare.Row, srcSquare.Col].FlatAppearance.BorderColor = Color.SandyBrown;
                    srcSquare = null;
                }
                else
                {
                    dstSquare = (Square)b.Tag;
                    matBoard[dstSquare.Row, dstSquare.Col].FlatAppearance.BorderColor = Color.SandyBrown;
            ...
            try
            {
                 Invoke((MethodInvoker)delegate {
                    ...
                    lblMove.Visible = true;
                     lblMove.ForeColor = Color.SaddleBrown;
                    ...
                    lblResult.ForeColor = Color.SaddleBrown;
                    label2.Visible = true;
                    this.Refresh();
                 });
