...
//constractor of bishop
bishop::bishop(const unsigned int startRow, const unsigned int startCol, const char color) : piece(startRow, startCol, color, BISHOP)
{

}

Status bishop::checkMove(const unsigned int destRow, const unsigned int destCol)
{
